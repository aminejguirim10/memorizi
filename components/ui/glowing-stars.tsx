...
export const GlowingStarsBackgroundCard = ({
  ...
  return (
    <div
      ...
      className={cn(
        "h-full w-full bg-[linear-gradient(110deg,#333_0.6%,#fda144)] p-4",
        className
      )}
      style={{
        width: "100vw",
...
const Glow = ({ delay }: { delay: number }) => {
  return (
    <motion.div
      ...
      className="absolute left-1/2 z-10 h-[4px] w-[4px] -translate-x-1/2 rounded-full bg-orange-400 shadow-2xl shadow-orange-300 blur-[1px]"
    />
  )
}
