...
<div className="bg-gray-300 py-2 px-4 rounded-lg dark:text-black ">
  <div className="flex  items-center gap-2">
    ...
    <div>
      {" "}
      You can update more than one field at a time. Click the <span className="text-orange-400">
        Update
      </span> button to save your changes.
    </div>
  </div>
</div>
