                      ...
                      <tbody style="width: 100%">
                        <tr style="width: 100%">
                          ...
                          <td
                            data-id="__react-email-column"
                            style="
                              border-bottom: 1px solid rgb(255, 166, 49);
                              width: 102px;
                            "
                          ></td>
                          <td
                ...
                <tr>
                  <td>
                    ...
                    >
                      ...
                      <a
                        href="${link}"
                        style="color: #ffa631; text-decoration: underline"
                        target="_blank"
                        >Memorizi Support</a
                      >
                    </p>
                    <p
                      style="font-size: 14px; line-height: 1.5; margin: 16px 0"
                    >
                      Thanks,<br />Memorizi Support Team
                    </p>
                  </td>
                </tr>
              </tbody>
      ...
      <tbody>
        <tr style="width: 100%">
          <td>
            ...
            <p style="font-size: 16px; line-height: 26px; margin: 16px 0">
              Welcome to Memorizi, the platform that helps you to save your
              memories and photos.
            </p>
            <table
              align="center"
